...
<div>
    ...
    <center><h1>Iniciar sesión como alumno</h1></center>
    
    <div>
    <form method="post" action="procesar_login_alumno.php">
    <br><center><img class="pequeña" src="img/rocko.jpg" alt=""></center></br>
        ...
        <center><p>¿No tienes una cuenta? <a href="registro.php">Regístrate</a></p></center>
    </div> 
</div>
</body>
</html>